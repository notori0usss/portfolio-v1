...
function Bio() {
    return (
        <div className="py-32 grid grid-cols-1 lg:grid-cols-3 max-w-6xl mx-auto container items-start gap-24 bg-white">
            ...
            <div>
                <div className="space-y-4 font-semibold p-2 ">
                    ...
                    <div className="flex gap-2 items-center hover:text-[#455CE9]">
                        <BiChevronDown/>
                        UI/UX Design
                    </div>
